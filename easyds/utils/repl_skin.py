"""easyds REPL skin — terminal interface for the interactive shell.

Usage:
    from easyds.utils.repl_skin import ReplSkin

    skin = ReplSkin("easyds", version="1.0.1")
    skin.print_banner()  # auto-detects skills/SKILL.md inside the package
    prompt_text = skin.prompt(project_name="my_dataset", modified=True)
    skin.success("Project saved")
    skin.error("File not found")
    skin.warning("Unsaved changes")
    skin.info("Processing 24 chunks...")
...
class ReplSkin:
    """REPL skin for the easyds interactive shell.

    Provides branding, prompts, and consistent message formatting.
    """
    ...
    def _detect_color_support(self) -> bool:
        ...
        if os.environ.get("NO_COLOR"):
            return False
        if os.environ.get("EASYDS_NO_COLOR"):
            return False
    ...
    def print_banner(self):
        ...
        brand = self._c(_CYAN + _BOLD, "easyds")
